...
void Test_SPI_Gyro(void)
{
    ...
    switch(GyroType)
    {
        ...
        case SPI_ICM42688:
            ...
            break;
        case SPI_LSM6DSR:
            Display_showString(0, 2, "   LQ LSM6DSR Test", U16_WHITE, U16_BLACK, 24);
            break;
        case SPI_LQ9AGMV:
            Display_showString(0, 2, "   LQ LQ9AGMV Test", U16_WHITE, U16_BLACK, 24);
            break;
        default :GyroType = error;Display_showString(0, 2, "ICM Test Fail", U16_WHITE, U16_BLACK, 16);break;
...
unsigned char SPI_Gryo_Init(void)
{
    ...
    PIN_InitConfig(P11_11, PIN_MODE_OUTPUT, 1);
